...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/brespect/js2048.git
   ```
...
After starting the project, it will be available at `http://localhost:8080`. Use the arrow keys to move the tiles, combine matching values, and work toward the 2048 tile. You can restart the game at any time using the restart button.
...
- **CSS3**: Styles the game and provides responsive layouts.
- **JavaScript (ES6)**: Implements the game logic and interactivity.
- **Git**: Provides version control.
- **GitHub**: Hosts the repository and demo.
